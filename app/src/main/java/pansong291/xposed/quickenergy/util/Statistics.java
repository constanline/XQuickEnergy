...
public class Statistics {
    ...
    private static final String jn_year = "year", jn_month = "month", jn_day = "day",
            ...
            jn_exchangeList = "exchangeList", jn_questionHint = "questionHint", jn_donationEggList = "donationEggList",
    ...
    public static void resetToday() {
        ...
        // Log.recordLog("原：" + stat.year.time + "-" + stat.month.time + "-" +
        // stat.day.time + "；新：" + formatDate);
